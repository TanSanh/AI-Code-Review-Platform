  ...
  return (
    <svg width="40" height="24" viewBox="0 0 40 24" fill="none" className="shrink-0" aria-hidden="true">
      <path
        ...
        stroke="currentColor"
        strokeWidth="2"
        className="text-gray-200 dark:text-[#1e2d44]/80"
      />
    </svg>
  );
}
...
function Avatar({ author }: { author: CommentAuthor }) {
  return author.avatarUrl ? (
    ...
    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gray-100 text-xs font-semibold text-gray-600 dark:bg-[#1e2d44] dark:text-gray-300">
  ...
  return (
    <div className="mt-2 flex items-center gap-2">
      <input
        ...
        className="flex-1 rounded-full border border-gray-200 bg-white px-4 py-2 text-sm text-gray-900 placeholder:text-gray-400 focus:border-gray-900 focus:outline-none focus:ring-1 focus:ring-gray-900/10 dark:border-[#1e2d44] dark:bg-[#0b1120] dark:text-gray-100 dark:placeholder:text-gray-600 dark:focus:border-gray-100"
      />
      <button
    ...
    <div>
      ...
      <div className="mb-4 flex gap-2">
        {user?.avatarUrl ? (
          ...
          <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-gray-100 text-xs font-semibold text-gray-600 dark:bg-[#1e2d44] dark:text-gray-300">
